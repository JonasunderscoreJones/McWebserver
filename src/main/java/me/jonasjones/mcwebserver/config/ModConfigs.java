...
public class ModConfigs {
    ...
    private static void createConfigs() {
        ...
        config.addKeyValuePair(new Pair<>("web.password", ""), "the password for accessing files on the webserver. leave blank for no password");
    ...
    private static void assignConfigs() {
        ...
        WEB_PASSWORD = CONFIG.getOrDefault("web.password", "");
